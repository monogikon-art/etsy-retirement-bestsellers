...
export async function ensureSchema() {
  ...
  // AI vision metadata: rule-book tags the embedded AI Agent assigns to each listing image.
  await sql`ALTER TABLE listings ADD COLUMN IF NOT EXISTS ai_metadata JSONB`;
  await sql`ALTER TABLE listings ADD COLUMN IF NOT EXISTS ai_tagged_at TIMESTAMPTZ`;
